...
class PoupeeRusse {
    ...
    public nom: string;
    private parent: PoupeeRusse | undefined = undefined;
    private enfant: PoupeeRusse | undefined = undefined;
    private isOpen: boolean = false;

    //constructor 
    constructor(taille: number, nom: string) {
        this.taille = taille;
        this.nom = nom;
    }
